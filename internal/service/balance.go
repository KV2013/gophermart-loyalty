...
func NewBalanceService(balanceRepository BalanceRepository, userRepository UserRepository, orderRepository OrderRepository, logger *zap.Logger) *balanceService {
